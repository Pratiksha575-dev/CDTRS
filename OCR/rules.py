...
DEPARTMENT_KEYWORDS: dict[str, list[str]] = {
    "Finance": [
        ...
        "fund release", "contingency", "pay bill", "deduction",
    ],
    "HR": [
        ...
        "attendance", "disciplinary", "suspension", "termination", "joining",
    ...
    "Administration": [
        "meeting", "circular", "notice", "event", "facility",
        "vehicle", "accommodation", "stationery", "housekeeping", "security",
        "guest house", "protocol", "general administration", "gazette",
        "record", "file", "dispatch", "dak", "office order", "tour",
        "inspection", "calendar", "schedule", "seating", "pass",
    ],
    "Maintenance": [
    ...
    "Legal": [
        "court", "litigation", "act", "regulation", "compliance", "contract",
        "agreement", "legal", "clause", "statute", "petition", "writ",
        "judgment", "verdict", "arbitration", "tribunal", "jurisdiction",
        "affidavit", "fir", "bail", "appeal", "show cause", "legal notice",
        "suo motu", "contempt", "high court", "supreme court",
    ],
    "Operations": [
        "project", "implementation", "execution", "deployment", "report",
        "progress", "milestone", "phase", "completion", "field",
        "site", "construction", "monitoring", "evaluation", "output",
        "target", "achievement", "performance", "review", "quarterly",
    ],
    "Medical / Health": [
        "medical", "health", "hospital", "patient", "treatment", "medicine",
        "doctor", "nurse", "clinic", "esi", "cghs", "dispensary",
        "reimbursement of medical", "prescription", "diagnosis", "surgery",
        "ambulance", "health check", "wellness",
    ],
    "Education & Training": [
        "training", "education", "workshop", "seminar", "conference",
        "scholarship", "course", "syllabus", "examination", "marks",
        "result", "institute", "school", "college", "university",
        "capacity building", "skill development", "e-learning", "certification",
    ],
}
